...
ActiveRecord::Schema[7.0].define(version: 2026_09_07_000002) do
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.string "consent_version", limit: 20
    t.string "consent_ip_address", limit: 45
    t.string "consent_user_agent", limit: 255
    t.datetime "anonymized_at"
    t.index ["assessment_id"], name: "index_sessions_on_assessment_id"
    t.index ["candidate_id"], name: "index_sessions_on_candidate_id"
    t.index ["created_at", "anonymized_at"], name: "idx_sessions_retention_cleanup"
